...
const ComputeResourcesPage = () => {
  ...
  useEffect(() => {
    ...
    const foundMethod = contributionMethods.find(m => m.id === 'compute-resources');
    if (foundMethod) {
      ...
      >
        ...
        <motion.div variants={slideUp} className="mt-8">
          <div className="bg-card border border-border rounded-lg p-8 text-center text-muted-foreground">
            ...
            <p>The Computing Resources contribution method is under development and will be available soon.</p>
            <p className="mt-2">This feature will allow you to contribute CPU/GPU cycles for distributed computing tasks and scientific research.</p>
          </div>
        </motion.div>
      </motion.div>
    </Layout>
