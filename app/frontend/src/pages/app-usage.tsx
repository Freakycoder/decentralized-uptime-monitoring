...
const AppUsagePage = () => {
  ...
  useEffect(() => {
    ...
    const foundMethod = contributionMethods.find(m => m.id === 'app-usage');
    if (foundMethod) {
      ...
      >
        ...
        <motion.div variants={slideUp} className="mt-8">
          <div className="bg-card border border-border rounded-lg p-8 text-center text-muted-foreground">
            ...
            <p>The App Usage Metrics contribution method is under development and will be available soon.</p>
            <p className="mt-2">This feature will allow you to share anonymous app usage patterns for performance insights and improvements.</p>
          </div>
        </motion.div>
      </motion.div>
    </Layout>
